	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','ajaxStatus'),
				'users'=>array('@'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','AjaxCheckAlarm'),
				'users'=>array('@'),
			),
        ...
        public function actionAjaxCheckAlarm()
        {
            $model=new Alert;
            $dataProvider = $model->search(15,true);
		...
		if(isset($_POST['status']) && isset($_POST['id']))
			{
				...
				$_POST['Alert']['status'] = $_POST['status'];
				$_POST['Alert']['user_id'] = $_POST['user_id'];
				$model->attributes=$_POST['Alert'];
				if($model->save());
			}
   		 echo $_POST['status'];
