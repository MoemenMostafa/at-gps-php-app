...
/**
 * This is the model class for table "maint_group".
 *
 * The followings are the available columns in table 'maint_group':
 * @property integer $id
 ...
 */
class MaintGroup extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MaintGroup the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'maintItems' => array(self::HAS_MANY, 'MaintItem', 'maint_group_id'),
		);
	}
