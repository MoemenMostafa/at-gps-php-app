 ...
 */
class CompanyAdmin extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'geofence' => 'Geofence',
			'overspeed_value' => 'Overspeed',
			'rpm_value' => 'RPM',
			'fueltemp_value' => 'Fueltemp',
			'oilpres_value' => 'Oil press.',
			'engtemp_value' => 'Engine temp.',
			'fuellevel_value' => 'Fuel level',
			'fuelrate_value' => 'Fuel rate',
			'accpedal_value' => 'Acc. pedal %',
		);
	}
