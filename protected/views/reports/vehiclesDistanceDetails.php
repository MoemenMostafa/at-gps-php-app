...
if ($dataProvider->totalItemCount > 0){
        ...
        echo CHtml::link('Export CSV',array('reports/vehiclesDistanceDetails&export=true&vehicleId='.$device_id.'&dateRange='.$date),array('class'=>'btn btn-primary  ui-button ui-widget ui-state-default ui-corner-all'));
        echo CHtml::link('Export As Separate vehicles CSV',array('reports/vehiclesDistanceDetails&export_separate_vehicles=true&vehicleId='.$device_id.'&dateRange='.$date),array('class'=>'btn btn-primary  ui-button ui-widget ui-state-default ui-corner-all'));
