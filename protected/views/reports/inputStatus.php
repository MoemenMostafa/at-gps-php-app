...
if ($dataProvider->totalItemCount > 0){
        ...
        //print_r($data);
                //echo $array;
        echo "<button class=\"btn btn-primary  ui-button ui-widget ui-state-default ui-corner-all\" onclick=\"printContent('inputStatus-grid');\"><i class=\"icon-white icon-print\"></i></button>";
       ...
       $this->widget('zii.widgets.grid.CGridView', array(
    	'id' => 'inputStatus-grid',
	   'dataProvider'=>$dataProvider,
	   'summaryText'=>'Input Status Report &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$_POST['Vehicle']['dateRange'].' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Device Type: '.$deviceType, // Updated report name with device type
            'selectableRows' => 0,
            ...
            'columns' => array(
                ...
                array(
					...
					"header" => "Datetime",
			   		'value'=>'reformDateTime($data->gps_datetime, Yii::app()->user->timezone)',
                ...
                array(
					...
					"header" => "Input Status",
			   		'value'=>'(openOrClosed($data->input_status, "'.$deviceType.'"))',
				...
				array(
					...
					"header" => "Location",
			   		'value'=>'getAddress($data->latitude, $data->longitude)',
			   		'htmlOptions'=>array('dir'=>'rtl', 'style'=>'text-align:center;'),
...
function openOrClosed($input_status, $device_type){
    echo "<script>";
    echo "console.log('input_status: " . $input_status . "');";
    echo "console.log('device_type: " . $device_type . "');";
    echo "</script>";
    if($device_type == 'A1CANBus'){
        return $input_status == 1 || $input_status == 0 ? 'Open' : 'Closed';
    } elseif($device_type == 'intellitrac X8'){
        return $input_status == 12 || $input_status == 14 ? 'Open' : 'Closed';
    } else {
