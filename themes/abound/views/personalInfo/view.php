...
$this->menu=array(
	...
	array('label'=>'<i class="icon icon-pencil"></i> Update PersonalInfo','url'=>array('update','id'=>$model->pesonal_info_id)),
	array('label'=>'<i class="icon icon-remove"></i> Delete PersonalInfo','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->pesonal_info_id),'confirm'=>'Are you sure you want to delete this item?')),
